...
const Footer = () => {
  ...
  <div className="max-w-6xl mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
      ...
      {/* Navigation Links */}
      {["Products", "Resources", "Solutions", "About"].map((section) => (
    ...
    {/* Bottom Section: Copyright, Email, and Social Icons */}
    <div className="flex flex-col md:flex-row items-center justify-between border-t border-gray-800 pt-6">
      ...
      <div className="flex items-center space-x-4 mb-4 md:mb-0">
        <input
          ...
          className="bg-gray-800 text-white px-4 py-2 rounded-l focus:outline-none w-64"
        />
        <button className="bg-blue-500 text-white px-6 py-2 rounded-r hover:bg-blue-600 transition-colors flex items-center">
          Subscribe
          <svg
