...
const Footer = () => {
  ...
  const footerData = {
    sections: {
      Products: ['Genius', 'Rainbow', 'Opus', 'Wildcard', 'Thrive', 'Hawkeye'],
      Resources: ['Documentation', 'Guides', 'API Reference', 'Blog', 'Community', 'Status'],
          ...
          <div className="flex space-x-4">
            {footerData.socialIcons.map((social) => (
              <a
                key={social.name}
                href={social.href}
                className="bg-gray-800 hover:bg-blue-500 text-white w-10 h-10 flex items-center justify-center rounded-full transition-all"
